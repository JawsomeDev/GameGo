    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                .authorizeHttpRequests(auth ->
                        auth.requestMatchers("/main","/", "sitemap.xml","/ads.txt", "/robots.txt", "/check-email-token","/error", "/reset-password/**" , "/reset-password-confirm" , "/reset-password/confirm" ,"/css/**", "/js/**", "/images/**", "/fonts/**"
